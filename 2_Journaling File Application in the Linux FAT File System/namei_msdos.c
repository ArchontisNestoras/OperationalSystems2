				   ...
				   unsigned int flags)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________STRUCT: msdos_lookup\n");
			   ...
			   struct timespec *ts, struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_add_entry\n");
			...
			bool excl)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_create\n");
...
static int msdos_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_rmdir\n");
...
static int msdos_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_mkdir\n");
...
static int msdos_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_unlink\n");
			...
			unsigned int flags)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/msdos/namei_msdos.c ________METHOD: msdos_rename\n");
