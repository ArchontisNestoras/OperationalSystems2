			  ...
			  struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________METHOD: vfat_add_entry\n");
				  ...
				  unsigned int flags)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________STRUCT: vfat_lookup\n");
...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________METHOD: vfat_rmdir\n");
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________METHOD: vfat_unlink\n");
...
static int vfat_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________METHOD: vfat_mkdir\n");
		       ...
		       unsigned int flags)
{
	...
	printk(KERN_INFO "IN THE________FILE: fs/vfat/fatent.c ________METHOD: vfat_rename\n");
